<script setup>
    ...
    const disableDate = (date) => {
        ...
        // fechas anteriores ni hoy y de más de un mes, domingos y sábados
    }
</script>
        ...
        <div class="lg:flex gap-5 items-start">
            ...
            >
                <button
                    ...
                    class="block text-blue-500 rounded-lg text-xl font-black p-3 disabled:opacity-10 disabled:cursor-not-allowed"
