    ...
    >
        ...
        <div class="flex gap-2 items-center">
            <RouterLink
                ...
                class="bg-slate-600 rounded p-3 text-white text-sm uppercase font-black flex-1 md:flex-none"
            >
                Editar Cita
            </RouterLink>
            <button
                class="bg-red-600 rounded p-3 text-white text-sm uppercase font-black flex-1 md:flex-none"
